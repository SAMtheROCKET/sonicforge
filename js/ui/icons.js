 ...
 * Inline SVG icon set.
 *
 * Icons are stroke paths on a 24×24 grid, rendered inline rather than loaded
 * as a font or sprite sheet — an icon font would be a network request, and
 * SonicForge must render completely with zero network access.
 */
...
export const ICONS = {
  ...
  headphones: 'M4 15v-3a8 8 0 0 1 16 0v3M4 14h3v6H5a1 1 0 0 1-1-1v-5zM20 14h-3v6h2a1 1 0 0 0 1-1v-5z',
  shield: 'M12 3l8 3v6c0 5-3.5 8-8 9-4.5-1-8-4-8-9V6l8-3z',
  flask: 'M9 3v6L4 19a1.6 1.6 0 0 0 1.4 2h13.2A1.6 1.6 0 0 0 20 19l-5-10V3M8 3h8M7.5 14h9',
  phone: 'M4 5c0-1 1-2 2-2h2l2 4-2 2a12 12 0 0 0 5 5l2-2 4 2v2c0 1-1 2-2 2A16 16 0 0 1 4 5z',
  activity: 'M2 12h4l3-8 4 16 3-8h6',
  users: 'M16 19v-1a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v1M9 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM21 19v-1a4 4 0 0 0-3-3.8M16 4.2a4 4 0 0 1 0 7.6',
  link: 'M9.5 14.5a4 4 0 0 0 5.7 0l3-3a4 4 0 0 0-5.7-5.7l-1.2 1.2M14.5 9.5a4 4 0 0 0-5.7 0l-3 3a4 4 0 0 0 5.7 5.7l1.2-1.2',
  refresh: 'M21 12a9 9 0 1 1-2.6-6.4M21 4v5h-5',
  check: 'M4 12.5l5 5L20 6.5',
  x: 'M6 6l12 12M18 6L6 18',
  alert: 'M12 8v5M12 17h.01M10.3 3.9L2.5 17.4A2 2 0 0 0 4.2 20.4h15.6a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z',
 ...
 */
export function icon(name, { size = 16, cls = '', fill = false } = {}) {
  const d = ICONS[name];
  if (!d) return '';
...
/** Replace every <i data-icon="name"> placeholder in a subtree. */
export function hydrateIcons(root = document) {
  for (const el of root.querySelectorAll('[data-icon]')) {
    const name = el.dataset.icon;
    const size = Number(el.dataset.iconSize) || 16;
    if (!ICONS[name]) continue;
    el.outerHTML = icon(name, { size, cls: el.className });
  }
}
